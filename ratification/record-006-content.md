...
**Target:** `~/gordo-seal/spec/protocol.md` — Attestation Levels section
...
*[Remainder of existing Level 4 text from v0.3.0, with "Level 4" references updated to "Level 5"]*
